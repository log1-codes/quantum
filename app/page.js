...
export default function Home() {
  ...
  return (
    <>
      ...
      <Head>
        <title>quantum-home</title> {/* Page title */}
        <meta name="description" content="Welcome to the Quantum Home Page. Join the next generation of developers mastering algorithms through AI-powered learning." /> {/* Page description */}
      </Head>
